...
def get_demo_calendar_events() -> pd.DataFrame:
    demo = pd.DataFrame(
        [
            {"date": "2026-02-27", "name": "Birthday gift (Alex)", "amount": 180.0, "source": "calendar", "tag": "birthday"},
            {"date": "2026-02-28", "name": "Credit card repayment", "amount": 620.0, "source": "calendar", "tag": "card_repayment"},
        ]
    )
